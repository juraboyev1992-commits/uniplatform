                                ...
                                return (
                                    <div key={v.id} className="border border-gray-200 rounded-xl p-3 space-y-2">
                                        ...
                                        <div className="flex flex-wrap gap-2 text-[11px]">
                                            ...
                                            {/* ANIQLIK DOIRASI yaqinlik chegarasidan
                                                katta bo'lsa masofa tekshiruvi ma'nosiz:
                                                nuqta o'zi kilometrlarcha xato bo'lishi
                                                mumkin. Buni aytmasak, tasdiqlovchi
                                                "joydan 800 m" degan raqamga ishonadi. */}
                                            {v.accuracy != null && v.accuracy > CULTURAL_PROXIMITY_METERS && (
                                                <span className="px-2 py-1 rounded-lg bg-amber-50 border border-amber-200 text-amber-800">
                                                    Joylashuv aniq emas &mdash; masofa ishonchsiz
                                                </span>
                                            )}
                                            {v.distance != null && (
                                            ...
                                            {/* HUDUD - metodikaning talabi.
                                                Cheklov FAQAT qadamjo/turizm maskaniga
                                                tegishli; teatr, muzey, kino va xiyobon
                                                uchun joy cheklovi yo'q.
                                                `null` - hudud ko'rsatilmagan, ya'ni
                                            ...
                                            {regionAllowsCredit(v.placeType, v.region) === false && (
                                                <span className="px-2 py-1 rounded-lg bg-rose-50 border border-rose-200 text-rose-800 font-bold">
                                                    OTM joylashgan hududdagi qadamjo — metodika bo&rsquo;yicha hisobga olinmaydi
                                                </span>
                                            )}
                                            {regionAllowsCredit(v.placeType, v.region) === null && (
                                                <span className="px-2 py-1 rounded-lg bg-amber-50 border border-amber-200 text-amber-800">
                                                    Hudud ko&rsquo;rsatilmagan
                                                </span>
                                            )}
                                        </div>
